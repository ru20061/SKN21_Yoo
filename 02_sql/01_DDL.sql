...
create user 'yoo'@'localhost' identified by '0000';

-- 원격 접속 계정

create user 'yoo'@'%' identified by '0000';
...
grant all privileges on *.* to 'yoo'@'localhost';

grant all privileges on *.* to 'yoo'@'%';

show grants for 'yoo'@'localhost';
show grants for 'yoo'@'%';
